			...
			<div class="collapse navbar-collapse" id="navbarResponsive">
				<ul class="navbar-nav ms-auto">
					<li class="nav-item mx-0 mx-lg-1"><a
						class="nav-link py-3 px-0 px-lg-3 rounded" href="#app">Application</a></li>
					<li class="nav-item mx-0 mx-lg-1"><a
					...
					<li class="nav-item mx-0 mx-lg-1 bg-danger"><a data-bs-toggle="modal" data-bs-target="#staticBackdrop"
							class="nav-link py-3 px-0 px-lg-3 rounded" href=""><%=session.getAttribute("fname")%></a>
					</li>
				</ul>
			</div>
		</div>
	...
	<header class="masthead bg-primary text-white text-center">
		<div class="container d-flex align-items-center flex-column">
			...
			<img class="masthead-avatar mb-5" src="assets/img/avataaars.svg"
				alt="..." />
			<!-- Masthead Heading-->
			<h1 class="masthead-heading text-uppercase mb-0">Welcome To Forinote</h1>
			<!-- Icon Divider-->
		...
		<section id="app">
			<div class="container">
				<div class="card" style="width: 18rem;">
					<img src="images/notes_img.png" class="card-img-top" alt="...">
					<div class="card-body">
